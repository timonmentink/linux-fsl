...
int __init mx35_clocks_init(void)
{
	...
	clk_register_clkdev(clk[uart2_gate], "per", "imx-mdb-guf.1");
	clk_register_clkdev(clk[ipg], "ipg", "imx21-uart.1");
	clk_register_clkdev(clk[ipg], "ipg", "imx-mdb-guf.1");
	...
	clk_register_clkdev(clk[ipg], "ipg", "imx-pwm.0");
	clk_register_clkdev(clk[pwm_gate], "per", "imx-pwm.0");
